...
- Говори на русском, конкретные английские слова и фонемы называй на английском.`;
  ...
  // Одновременность — не больше шести (решение владельца 2026-09-18). У
  // расшифровки звука видео в очереди платных вызовов аккаунта мест не меньше
  // (server_config.inflight_limits), так что все шесть уходят разом;
