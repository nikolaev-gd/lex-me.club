...
(function (global) {
  ...
  //   · в выкладке всё сложено плоско в один каталог `/app/`, и «уровня выше»
  //     там просто нет — над ним лежит сам сайт.
  ...
  const SELF_DIR = (document.currentScript && document.currentScript.src)
    ...
    : './';
  const HEIF_CANDIDATES = ['vendor/libheif-bundle.js', '../vendor/libheif-bundle.js'];
